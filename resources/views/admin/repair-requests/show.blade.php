        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 space-y-6">
                    ...
                    @if ($repairRequest->status === 'repair_completed' && !$repairRequest->invoice)
                        <div class="border-t pt-6">
                            ...
                            <p class="text-gray-700 mb-4">
                                This repair has been completed by the technician. You can now generate the invoice for the customer.
                            </p>
                    ...
                    @if ($repairRequest->status === 'ready_for_pickup')
                        <div class="border-t pt-6">
                            ...
                            <p class="text-gray-700 mb-4">
                                Payment has been received and the customer has been notified. Confirm below only after the customer has physically collected the device.
                            </p>

                            <form method="POST" action="{{ route('admin.repair-requests.confirm-pickup', $repairRequest) }}">
                                @csrf
                                @method('PATCH')

                                <button type="submit"
                                    class="px-4 py-2 bg-purple-600 text-white rounded-md text-sm hover:bg-purple-700"
                                    onclick="return confirm('Confirm that the customer has collected the device?')">
                                    Confirm Device Collected
                                </button>
                            </form>
                        </div>
                    @endif
